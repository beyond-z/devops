...
echo "### Restoring Kits staging Attendance DB from $kits_latest_dump_attendance_s3_path"
...
if [ $? -ne 0 ]
then
  echo "Error: Failed restoring from $kits_latest_dump_attendance_s3_path database"; 
...
echo "### Done: Restoring Kits staging Attendance DB from $kits_latest_dump_attendance_s3_path"
