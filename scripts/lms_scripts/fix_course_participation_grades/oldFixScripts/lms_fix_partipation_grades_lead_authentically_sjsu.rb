...
# vim fix_grades_sjsu_lead_authentically.rb
# paste the contents of this file in there and save
# sudo su canvasuser -c "RAILS_ENV=production script/rails console"
# $stdout = File.new('/tmp/fix_grades_sjsu_lead_authentically.txt', 'w')
# $stdout.sync = true
# load 'fix_grades_sjsu_lead_authentically.rb'

def fix_grades

  module_item_id = 3769
  course_id = 27
  module_name = 'Lead Authentically'
